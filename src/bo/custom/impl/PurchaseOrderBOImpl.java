...
public class PurchaseOrderBOImpl implements PurchaseOrderBO {
    ...
    private final OrderDetailsDAO orderDetailsDAO = (OrderDetailsDAO) DAOFactory.getDAOFactory().getDAO(DAOFactory.DAOTypes.ORDERDETAIL);
    ...
    public boolean purchaseOrder(OrderDTO dto) throws SQLException, ClassNotFoundException {
        ...
        for (OrderDetailDTO detail : dto.getOrderDetail()) {
            OrderDetail orderDetailDTO = new OrderDetail(detail.getCode(), dto.getOrderId(), detail.getQty(), detail.getUnitPrice());
            ...
            //Search & Update Item
            Item search = itemDAO.search(detail.getCode());
    ...
    public CustomerDTO searchCustomer(String s) throws SQLException, ClassNotFoundException {
        ...
        return new CustomerDTO(c.getCustomerId(), c.getTitle(), c.getName(), c.getAddress(), c.getCity(), c.getProvince(), c.getPostalCode());
    }
}
